...
3. A lot of proposals in the contact information are no longer valid, please screen yourself, but also, do not feel free to disturb others ha.

## Links

### GitHub (Recommend)

Click this link to jump: https://github.com/OpenSource-enthusiastic/OSPP-Proposals

Click following links to clone to local:
...
"OSPP application materials" https://www.aliyundrive.com/s/e7msDRF8u1c
Click the link to save, or copy this paragraph, open the "Aliyun Disk" APP, no download speed online view, video original picture times faster playback.

### Baidu Pan

Links: https://pan.baidu.com/s/1aQCXRxZfbUB6hDJYK4cWcA
Pwd: 1234
