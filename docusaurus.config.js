    ...
    ({
      navbar: {
        ...
        items: [
          {
            type: 'doc',
            docId: 'HowToAskQuestion',
            position: 'left',
            label: 'Tutorial',
          },
          {to: '/blog', label: 'Blog', position: 'left'},
          {
            href: 'https://github.com/OpenSource-enthusiastic',
            label: 'GitHub',
            position: 'right',
          },
        ],
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                label: 'Slack',
                href: 'https://join.slack.com/t/gsoc--cn/shared_invite/zt-17xq5m4td-6fWKsMtYlqUnLjpH3lBmxQ',
              },
              /*{
                label: 'Discord',
